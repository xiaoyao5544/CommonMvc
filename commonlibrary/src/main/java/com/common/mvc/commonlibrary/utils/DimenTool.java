...
public class DimenTool {
    ...
    public static void gen() {
        ...
        File file = new File("./jsslibrary/src/main/res/values/dimens.xml");
       ...
       /* StringBuilder sw240 = new StringBuilder();
        ...
        try {
            ...
            while ((tempString = reader.readLine()) != null) {
                ...
                if (tempString.contains("</dimen>")) {
                  ...
                  /*  sw240.append(start).append(num * 0.75).append(end).append("\r\n");
                    ...
                    w720.append(start).append(new BigDecimal(num / 3).setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue()).append(end).append("\r\n");

                    //w1080.append(start).append(num*1.5).append(end).append("\r\n");
          ...
          /*  System.out.println("<!--  sw240 -->");
            ...
            String w720file = "./jsslibrary/src/main/res/values-xhdpi/dimens.xml";

            String w1080file = "./jsslibrary/src/main/res/values-xxhdpi/dimens.xml";

            String w800file = "./jsslibrary/src/main/res/values-xxhdpi/dimens.xml";
            //将新的内容，写入到指定的文件中去
           /* writeFile(sw240file, sw240.toString());
            ...
            writeFile(w800file, w720.toString());
